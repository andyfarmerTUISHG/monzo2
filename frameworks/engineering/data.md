...
topics:
  ...
  - name: "leadership"
    ...
    content:
      ...
      - level: 4
        criteria:
          - "Contributes to maintaining the Bluecrest Wellness culture in their team, helping new joiners"
          - "Gets buy-in on technical decision-making and proposed designs"
          - "Proactively involves other relevant engineers"
          - "Sought out for code reviews"
          - "Instills Bluecrest Wellness engineering principles in other engineers"
      ...
      - level: 5
        criteria:
          - "Instills Bluecrest Wellness engineering principles across a whole squad of engineers"
          ...
          - "Contributes to maintaining the Bluecrest Wellness culture in the wider company"
  ...
  - name: "influence"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Represents Bluecrest Wellness at conferences/events"
          - "Given as reason for other engineers to join Bluecrest Wellness"
    ...
    content:
      ...
      - level: 5
        criteria:
          ...
          - "Contributes to maintaining Bluecrest Wellness’s culture in the wider company"
...
### How does it work?
The framework covers all the things we’re looking for from engineers at Bluecrest Wellness. We’re interested in these five elements:
- Mastery - Your Bluecrest Wellness knowledge and technical capability
...
- There are many different ways to progress and be valuable to Bluecrest Wellness as you grow, including deep technical knowledge and ability, technical leadership and people management. All are equally valuable paths in Bluecrest Wellness's engineering team.
