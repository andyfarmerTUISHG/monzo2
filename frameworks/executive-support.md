...
topics:
  - name: "communication"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Gives external talks on role of EAs at Bluecrest Wellness, and how this creates value and contributes to Bluecrest Wellness's overall success."
  - name: "impact"
    title:
    content:
      - level: 2
      ...
      - level: 5
        criteria:
          ...
          - "Owns projects that impact Bluecrest Wellness as a whole, leveraging stakeholders to deliver results."
  - name: "knowledge"
    title:
    content:
      - level: 1
        exampleCriteria:
          - criteria: "Learning how to use all Bluecrest Wellness's internal tools"
            examples:
              - "GSuite"
              - "Slack"
              - "Lattice"
      ...
      - level: 2
        criteria:
          - "Working knowledge of all Bluecrest Wellness tools"
          - "Can organise basic travel arrangements"
          - "Can work across timezones"
      - level: 3
        criteria:
          - "Power user of all Bluecrest Wellness tools"
      ...
      - level: 5
        criteria:
          - "Strong understanding of all executives responsibilities at Bluecrest Wellness, with ability to adapt to support any executive to high standard at short notice."
  - name: "teamwork"
    title:
    content:
      - level: 3
